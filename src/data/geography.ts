...
// Generar zonas estándar (1-25)
export const GT_ZONES = Array.from({length: 25}, (_, i) => `Zona ${i + 1}`);

// Lista de Municipios que realmente utilizan sistema de Zonas en Guatemala
// Basado en planificación urbana metropolitana y ciudades intermedias.
export const MUNICIPALITIES_WITH_ZONES = [
  "Guatemala",
  "Mixco",
  "Villa Nueva",
...
// Departamentos y sus Municipios (Datos oficiales INE)
export const GT_DEPARTMENTS: { [key: string]: string[] } = {
  "Guatemala": [
